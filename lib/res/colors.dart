...
class Colours {
  static const Color app_main = Color(0xFF09C688);
  static const Color dark_app_main = Color(0xFF09C688);

  static const Color bg_color = Color(0xff03140B);
  static const Color dark_bg_color = Color(0xff03140B);
  

  static const Color material_bg = Color(0xFF03140B);
  static const Color dark_material_bg = Color(0xFF03140B);
  ...
  static const Color bg_gray = Color(0xff03140B);
  ...
  static const Color bg_gray_ = Color(0xff03140B);
